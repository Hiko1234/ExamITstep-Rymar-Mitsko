...
// import styles
import s from "./CardDepartmentSmall.module.scss"
// import link
...
const CardDepartmentSmall = () => {
    return (
        <>
            {dataDepartment.map((card) => (
                <div className={s.cardDepartmentSmallWrapper}>
                    <Link className={s.cardDepartmentSmall} href={`/department${card.path}`}>
                        <div className={s.cardDepartmentSmall__imgWrapper}>
                            <Image className={s.cardDepartmentSmall__img} src={card.image} alt={card.text} width={45} height={45} />
                        </div>
                        <div className={s.cardDepartmentSmall__title}>{card.text}</div>
                    </Link>
                </div>
            ))}
        </>
...
export default CardDepartmentSmall