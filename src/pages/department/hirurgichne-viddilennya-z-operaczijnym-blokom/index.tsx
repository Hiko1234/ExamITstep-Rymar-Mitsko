...
// title page 
const title = [
  { img: department18, title: "Хірургічне відділення з операційним блоком", number: "7-05-62" },
];
...
const HirurgichneViddilennyaZOperaczijnymBlokom = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Хірургічне відділення з операційним блоком") {
        return el
      }
    })
...
export default HirurgichneViddilennyaZOperaczijnymBlokom