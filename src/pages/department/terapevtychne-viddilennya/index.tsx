...
// title page 
const title = [
  { img: department15, title: "Терапевтичне відділення", number: "7-05-62" },
];
...
const TerapevtychneViddilennya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Терапевтичне відділення") {
        return el
      }
    })
...
export default TerapevtychneViddilennya