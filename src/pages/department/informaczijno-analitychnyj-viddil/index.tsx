...
// title page 
const title = [
  { img: department1, title: "Інформаційно – аналітичний відділ", number: "7-05-62" },
];
...
const InformaczijnoAnalitychnyjViddil = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Інформаційно – аналітичний відділ") {
        return el
      }
    })
...
export default InformaczijnoAnalitychnyjViddil