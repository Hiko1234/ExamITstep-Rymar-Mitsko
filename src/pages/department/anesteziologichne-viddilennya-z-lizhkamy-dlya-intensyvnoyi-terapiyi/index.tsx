...
// title page 
const title = [
  { img: department19, title: "Відділення анестезіології та інтенсивної терапії", number: "7-05-62" },
];
...
const AnesteziologichneViddilennya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Відділення анестезіології та інтенсивної терапії") {
        return el
      }
    })
...
export default AnesteziologichneViddilennya