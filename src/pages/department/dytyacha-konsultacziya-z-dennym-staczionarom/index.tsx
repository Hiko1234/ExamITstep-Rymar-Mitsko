...
// title page 
const title = [
  { img: department9, title: "Дитяча консультація з денним стаціонаром", number: "7-05-62" },
];
...
const DytyachaKonsultacziyaZDennymStaczionarom = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Дитяча консультація з денним стаціонаром") {
        return el
      }
    })
...
export default DytyachaKonsultacziyaZDennymStaczionarom