...
// title page 
const title = [
  { img: department8, title: "Стоматологічне відділення", number: "7-05-62" },
];
...
const StomatologichneViddilennya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Стоматологічне відділення") {
        return el
      }
    })
...
export default StomatologichneViddilennya