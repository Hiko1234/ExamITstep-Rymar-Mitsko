...
// title page 
const title = [
  { img: department10, title: "Відділення медичних оглядів", number: "7-05-62" },
];
...
const ViddilennyaMedychnyhOglyadiv = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Відділення медичних оглядів") {
        return el
      }
    })
...
export default ViddilennyaMedychnyhOglyadiv