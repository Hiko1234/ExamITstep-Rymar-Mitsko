...
// title page 
const title = [
  { img: department16, title: "Неврологічне відділення з інсультним блоком", number: "7-05-62" },
];
...
const NevrologichneViddilennya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Неврологічне відділення з інсультним блоком") {
        return el
      }
    })
...
export default NevrologichneViddilennya