...
// title page 
const title = [
  { img: department14, title: "Урологічне відділення", number: "7-05-62" },
];
...
const UrologichneViddilennya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Урологічне відділення") {
        return el
      }
    })
...
export default UrologichneViddilennya