...
// title page 
const title = [
  { img: department7, title: "Клініко-діагностична лабораторія", number: "7-05-62" },
];
...
const KlinikoDiagnostychnaLaboratoriya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Клініко-діагностична лабораторія") {
        return el
      }
    })
...
export default KlinikoDiagnostychnaLaboratoriya