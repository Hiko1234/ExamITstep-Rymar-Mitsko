...
// title page 
const title = [
  { img: department13, title: "Травматологічне відділення", number: "7-05-62" },
];
...
const TravmatologichneViddilennya = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Травматологічне відділення") {
        return el
      }
    })
...
export default TravmatologichneViddilennya