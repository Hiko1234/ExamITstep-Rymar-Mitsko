...
// title page 
const title = [
  { img: department3, title: "Реабілітаційне відділення", number: "7-05-62" },
];
...
const Reabilitaczijne = () => {
  ...
  function getDoctorsByDepartment(data: any) {
    const targetDoctors = data.filter((el: any) => {
      if (el.department == "Реабілітаційне відділення") {
        return el
      }
    })
...
export default Reabilitaczijne